...
## PCIe5.0x16插槽接入EOP4A接入DEG1/2 与独立GPU无法正常使用

当PCIE5.0X16 开启ASPM并且开启 CLK_REQ功能后。 使用EOP4A拓展卡 外接OCulink设备，如显卡等，可能会有无法进入系统的问题。（已测试 Intel Arc Pro B60/AMD 9060XT LP无法进入OS）
...
将 `Pcie x16 Slot-Devicel` 更改为 `Enabled`
